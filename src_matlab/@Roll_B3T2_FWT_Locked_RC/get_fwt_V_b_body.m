function out = get_fwt_V_b_body(p,U,Xi)
	...
	rep_32 = -y_h.*(rep_17.*rep_23 + rep_19.*rep_22 + rep_21) + rep_17.*rep_18 + rep_19.*rep_20 + (-rep_11.*rep_13.*rep_17 + rep_11.*rep_27 + rep_13.*rep_19.*rep_5 - rep_13.*rep_25 + rep_24).*Xi(3,:) + (rep_10.*rep_19.*rep_2.*rep_4 - rep_11.*rep_29 - rep_11.*rep_31 - rep_28 - rep_30).*Xi(2,:);
	rep_33 = rep_16.*rep_5;
	rep_34 = y_h.*(rep_16.*rep_22 + rep_17 - rep_21.*rep_23) - rep_16.*rep_20 + rep_18.*rep_21 + (-rep_10.*rep_33 + rep_11.*rep_13.*rep_14.*rep_16 - rep_11.*rep_24 + rep_13.*rep_16.*U(7) - rep_27).*Xi(2,:) + (-rep_11.*rep_28 - rep_11.*rep_30 - rep_13.*rep_33 - rep_29 - rep_31).*Xi(3,:);
	%% create output vector
	out = [rep_10.*rep_12.*Xi(2,:) - rep_10.*rep_15.*Xi(3,:) + rep_12.*rep_13.*Xi(3,:) + rep_13.*rep_15.*Xi(2,:) - rep_5.*Xi(1,:);...
		 rep_16.*rep_32 + rep_19.*rep_34;...
		 rep_16.*rep_34 - rep_19.*rep_32];
end