function out = get_fwt_V_b_body_LHS(p,U,Xi)
	...
	rep_42 = rep_8.*U(14);
	rep_43 = b_i.*y_h;
	rep_44 = y_h.*(rep_1.*U(21) + rep_3.*U(23) - rep_43.*U(22));
	rep_45 = y_h.*U(14).*(rep_1.*U(8) + rep_3.*U(10) - rep_43.*U(9));
	rep_46 = y_h.*rep_9;
	rep_47 = rep_21.*rep_40;
	rep_48 = rep_13.*rep_41;
	rep_49 = rep_18.*rep_48;
	rep_50 = -rep_47 + rep_49;
	rep_51 = rep_13.*rep_40;
	rep_52 = rep_22.*rep_51;
	rep_53 = rep_28 + rep_31;
	rep_54 = rep_41.*rep_53;
	rep_55 = rep_52 + rep_54;
	rep_56 = rep_17.*rep_6;
	rep_57 = rep_21.*rep_41;
	rep_58 = rep_27.*rep_57;
	rep_59 = rep_13.*rep_18.*rep_40.*U(14) - rep_18.*rep_58 + rep_21.*rep_41.*U(14) - rep_27.*rep_51 - rep_48.*rep_56;
	rep_60 = rep_22.*rep_48;
	rep_61 = rep_27.*rep_47;
	rep_62 = rep_40.*rep_53;
	rep_63 = -rep_17.*rep_24 + rep_30.*rep_32 + rep_38;
	rep_64 = -rep_22.*rep_61 + rep_41.*rep_63 - rep_60.*U(14) + rep_62.*U(14);
	...
	rep_70 = rep_19.*rep_48.*U(14) + rep_19.*rep_61 + rep_40.*rep_68 + rep_41.*rep_69;
	rep_71 = rep_16.*rep_64;
	rep_72 = -rep_46.*(rep_40.*rep_45 - rep_41.*rep_42 + rep_41.*rep_44) + (rep_14.*rep_64 + rep_15.*rep_50 - rep_16.*rep_59 + rep_26.*rep_55).*Xi(3,:) + (rep_19.*rep_65 - rep_19.*rep_66 + rep_19.*rep_67 + rep_19.*rep_71 + rep_22.*rep_70).*Xi(1,:) + (-rep_19.*rep_70 + rep_22.*rep_65 - rep_22.*rep_66 + rep_22.*rep_67 + rep_22.*rep_71).*Xi(2,:);
	rep_73 = -rep_18.*rep_51 - rep_57;
	rep_74 = -rep_60 + rep_62;
	rep_75 = rep_18.*rep_61 - rep_27.*rep_48 - rep_47.*U(14) + rep_49.*U(14) + rep_51.*rep_56;
	rep_76 = rep_21.*rep_22.*rep_27.*rep_41 + rep_40.*rep_63 - rep_52.*U(14) - rep_54.*U(14);
	rep_77 = rep_26.*rep_73;
	rep_78 = rep_15.*rep_74;
	rep_79 = rep_14.*rep_75;
	rep_80 = rep_13.*rep_19.*rep_40.*U(14) - rep_19.*rep_58 + rep_40.*rep_69 - rep_41.*rep_68;
	rep_81 = rep_16.*rep_76;
	rep_82 = -rep_46.*(rep_40.*rep_42 - rep_40.*rep_44 + rep_41.*rep_45) + (rep_14.*rep_73.*U(26) - rep_14.*rep_76 - rep_16.*rep_75 - rep_26.*rep_74).*Xi(3,:) + (rep_19.*rep_77 + rep_19.*rep_78 + rep_19.*rep_79 - rep_19.*rep_81 - rep_22.*rep_80).*Xi(1,:) + (rep_19.*rep_80 + rep_22.*rep_77 + rep_22.*rep_78 + rep_22.*rep_79 - rep_22.*rep_81).*Xi(2,:);
	...
	out = [(-rep_13.*rep_15.*rep_6 + rep_13.*rep_16.*rep_17.*rep_18 + rep_14.*rep_33 - rep_16.*rep_21.*rep_27.*rep_6 + rep_25.*rep_26).*Xi(3,:) + (rep_14.*rep_19.*rep_21.*rep_27.*rep_6 + rep_16.*rep_19.*rep_33 - rep_19.*rep_37 - rep_22.*rep_39 - rep_28.*rep_34 - rep_36.*rep_38).*Xi(1,:) + (rep_14.*rep_21.*rep_22.*rep_27.*rep_6 + rep_16.*rep_22.*rep_33 + rep_19.*rep_39 - rep_22.*rep_37 - rep_23.*rep_34 - rep_35.*rep_36).*Xi(2,:);...
		 rep_40.*rep_72 + rep_41.*rep_82;...
		 rep_40.*rep_82 - rep_41.*rep_72];
end