function out = get_fwt_V_global_LHS(p,U,Xi)
	...
	rep_38 = rep_37.*U(12);
	rep_39 = cos(U(1));
	rep_40 = rep_37.*U(5).*U(8);
	rep_41 = rep_13.*rep_39;
	rep_42 = rep_35.*rep_7;
	...
	rep_48 = rep_35.*rep_47;
	rep_49 = rep_46 + rep_48;
	rep_50 = rep_12.*rep_4;
	rep_51 = rep_13.*rep_35;
	rep_52 = rep_14.*rep_51;
	rep_53 = rep_10.*rep_39.*rep_7.*U(8) - rep_10.*rep_52 + rep_13.*rep_35.*U(8) - rep_14.*rep_45 - rep_42.*rep_50;
	rep_54 = rep_17.*rep_42;
	rep_55 = rep_14.*rep_41;
	rep_56 = rep_39.*rep_47;
	rep_57 = -rep_12.*rep_19 + rep_24.*rep_26 + rep_34;
	rep_58 = -rep_17.*rep_55 + rep_35.*rep_57 - rep_54.*U(8) + rep_56.*U(8);
	rep_59 = rep_21.*rep_44;
	rep_60 = rep_49.*rep_9;
	rep_61 = rep_53.*rep_8;
	rep_62 = U(8).*(rep_17.*rep_4 - rep_32);
	rep_63 = rep_13.*rep_23 - rep_16.*rep_26 + rep_29;
	rep_64 = rep_15.*rep_42.*U(8) + rep_15.*rep_55 + rep_35.*rep_63 + rep_39.*rep_62;
	rep_65 = rep_11.*rep_58;
	rep_66 = -rep_10.*rep_45 - rep_51;
	rep_67 = -rep_54 + rep_56;
	rep_68 = rep_10.*rep_55 - rep_14.*rep_42 - rep_41.*U(8) + rep_43.*U(8) + rep_45.*rep_50;
	rep_69 = 2*y_h.*rep_1.*rep_13.*rep_17.*rep_35.*U(12) + rep_39.*rep_57 - rep_46.*U(8) - rep_48.*U(8);
	rep_70 = rep_21.*rep_66;
	rep_71 = rep_67.*rep_9;
	rep_72 = rep_68.*rep_8;
	rep_73 = rep_15.*rep_39.*rep_7.*U(8) - rep_15.*rep_52 - rep_35.*rep_62 + rep_39.*rep_63;
	rep_74 = rep_11.*rep_69;
	...
	out = [(rep_10.*rep_11.*rep_12.*rep_7 - rep_11.*rep_13.*rep_14.*rep_4 + rep_20.*rep_21 + rep_27.*rep_8 - rep_4.*rep_7.*rep_9).*Xi(3,:) + (2*y_h.*rep_1.*rep_13.*rep_15.*rep_4.*rep_8.*U(12) + rep_11.*rep_15.*rep_27 - rep_15.*rep_31 - rep_17.*rep_33 - rep_22.*rep_28 - rep_30.*rep_34).*Xi(1,:) + (2*y_h.*rep_1.*rep_13.*rep_17.*rep_4.*rep_8.*U(12) + rep_11.*rep_17.*rep_27 + rep_15.*rep_33 - rep_17.*rep_31 - rep_18.*rep_28 - rep_29.*rep_30).*Xi(2,:);...
		 rep_35.*rep_36 - rep_35.*rep_38 - rep_39.*rep_40 + (-rep_11.*rep_53 + rep_21.*rep_49 + rep_44.*rep_9 + rep_58.*rep_8).*Xi(3,:) + (rep_15.*rep_59 - rep_15.*rep_60 + rep_15.*rep_61 + rep_15.*rep_65 + rep_17.*rep_64).*Xi(1,:) + (-rep_15.*rep_64 + rep_17.*rep_59 - rep_17.*rep_60 + rep_17.*rep_61 + rep_17.*rep_65).*Xi(2,:);...
		 -rep_35.*rep_40 - rep_36.*rep_39 + rep_38.*rep_39 + (-rep_11.*rep_68 - rep_21.*rep_67 + rep_66.*rep_8.*U(14) - rep_69.*rep_8).*Xi(3,:) + (rep_15.*rep_70 + rep_15.*rep_71 + rep_15.*rep_72 - rep_15.*rep_74 - rep_17.*rep_73).*Xi(1,:) + (rep_15.*rep_73 + rep_17.*rep_70 + rep_17.*rep_71 + rep_17.*rep_72 - rep_17.*rep_74).*Xi(2,:)];
end